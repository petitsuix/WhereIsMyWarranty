...
enum Strings {
    ...
    static let termsAndConditions = "Conditions générales  "
...
// MARK: - Legal declarations
extension Strings {
    static let privacyPolicyBodyText = """
    Privacy Policy
    ==============
    ...
    For the purposes of this Privacy Policy:
      ...
      * Application means the software program provided by the Company downloaded
        by You on any electronic device, named Où est ma garantie ?

      * Company (referred to as either "the Company", "We", "Us" or "Our" in this
        Agreement) refers to Où est ma garantie ?.
    ...
    We may ask you to use, with Your prior permission:

      * Device's camera and photo library

    The photos use is just for your own use and Où est ma garantie ? will never monitor, access or use them in any way.

    You can enable or disable access to the camera and photo library at any time, through Your
    Device settings.
    ...
    We will never collect, or share any of Your personal information
    ...
    If you have any questions about this Privacy Policy, You can contact us:
      ...
      * By email: ianis.zedev@gmail.com
"""

    static let termsAndConditionsBodyText = "terms and conditions text"
}
