...
enum MWColor {
    static let bluegrey = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
    static let paleOrange = #colorLiteral(red: 0.9294154048, green: 0.7607811689, blue: 0.6470624208, alpha: 1)
